...
data_eurosoxx600 <- read_excel('EUROSOXX600 BONDS.xlsx', sheet = 'Tab1')
...
base_data_set <- create_base_data_set(data_eurosoxx600) 
...
dataset_Q12014 <- create_quarter_data_set(data_eurosoxx600, '2014Q1')
dataset_Q22014 <- create_quarter_data_set(data_eurosoxx600, '2014Q2')
dataset_Q32014 <- create_quarter_data_set(data_eurosoxx600, '2014Q3')
dataset_Q42014 <- create_quarter_data_set(data_eurosoxx600, '2014Q4')

dataset_Q12015 <- create_quarter_data_set(data_eurosoxx600, '2015Q1')
dataset_Q22015 <- create_quarter_data_set(data_eurosoxx600, '2015Q2')
dataset_Q32015 <- create_quarter_data_set(data_eurosoxx600, '2015Q3')
dataset_Q42015 <- create_quarter_data_set(data_eurosoxx600, '2015Q4')

dataset_Q12016 <- create_quarter_data_set(data_eurosoxx600, '2016Q1')
dataset_Q22016 <- create_quarter_data_set(data_eurosoxx600, '2016Q2')
dataset_Q32016 <- create_quarter_data_set(data_eurosoxx600, '2016Q3')
dataset_Q42016 <- create_quarter_data_set(data_eurosoxx600, '2016Q4')

dataset_Q12017 <- create_quarter_data_set(data_eurosoxx600, '2017Q1')
dataset_Q22017 <- create_quarter_data_set(data_eurosoxx600, '2017Q2')
dataset_Q32017 <- create_quarter_data_set(data_eurosoxx600, '2017Q3')
dataset_Q42017 <- create_quarter_data_set(data_eurosoxx600, '2017Q4')

dataset_Q12018 <- create_quarter_data_set(data_eurosoxx600, '2018Q1')
dataset_Q22018 <- create_quarter_data_set(data_eurosoxx600, '2018Q2')
dataset_Q32018 <- create_quarter_data_set(data_eurosoxx600, '2018Q3')
dataset_Q42018 <- create_quarter_data_set(data_eurosoxx600, '2018Q4')

dataset_Q12019 <- create_quarter_data_set(data_eurosoxx600, '2019Q1')
dataset_Q22019 <- create_quarter_data_set(data_eurosoxx600, '2019Q2')
dataset_Q32019 <- create_quarter_data_set(data_eurosoxx600, '2019Q3')
dataset_Q42019 <- create_quarter_data_set(data_eurosoxx600, '2019Q4')

dataset_Q12020 <- create_quarter_data_set(data_eurosoxx600, '2020Q1')
dataset_Q22020 <- create_quarter_data_set(data_eurosoxx600, '2020Q2')
dataset_Q32020 <- create_quarter_data_set(data_eurosoxx600, '2020Q3')
dataset_Q42020 <- create_quarter_data_set(data_eurosoxx600, '2020Q4')

dataset_Q12021 <- create_quarter_data_set(data_eurosoxx600, '2021Q1')
dataset_Q22021 <- create_quarter_data_set(data_eurosoxx600, '2021Q2')
dataset_Q32021 <- create_quarter_data_set(data_eurosoxx600, '2021Q3')
dataset_Q42021 <- create_quarter_data_set(data_eurosoxx600, '2021Q4')


#Bind Quarter Datasets Into Cleaned Dataset With Quarter Stacked
cleaned_total_dataset_eurosoxx600 <- rbind(dataset_Q12014, dataset_Q22014, dataset_Q32014,dataset_Q42014,
...
cleaned_total_dataset_eurosoxx600 <- cbind(
  cleaned_total_dataset_eurosoxx600, base_data_set)
...
total_data_set_eurosoxx600_and_sp500 <- rbind(stacked_quarter_dataset_sp500,cleaned_total_dataset_eurosoxx600 )
...
fundamentals <- read_excel('StoxxEurope and S&P Companies.xlsx', sheet = 'Tab1')
...
names(total_data_set_eurosoxx600_and_sp500)[10] = 'CUSIP'
...
mergedData <- dplyr::left_join(total_data_set_eurosoxx600_and_sp500, stacked_quarter_dataset_fundamentals, by = c("CUSIP", "Quarter"))
